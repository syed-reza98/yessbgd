...
export default function AdminProfile() {
  ...
  const sendPasswordReset = async () => {
    setPwMsg("পাসওয়ার্ড পরিবর্তনের জন্য অ্যাডমিন বা সুপার-অ্যাডমিনের সাথে যোগাযোগ করুন।");
  };
        ...
        <div className="space-y-5">
          ...
          <section className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground">
              পাসওয়ার্ড পরিবর্তন ও সিকিউরিটি কনফিগারেশন।
            </p>
            <button
              onClick={sendPasswordReset}
              className="mt-3 w-full rounded-lg border border-border px-4 py-2 text-sm font-semibold hover:bg-secondary"
            >
              Reset info · রিসেট তথ্য
            </button>
            {pwMsg && <p className="mt-2 text-xs text-primary">{pwMsg}</p>}
          </section>
        </div>
      </div>
    </div>
