...
const heroImgSrc = (heroImg as any)?.src || heroImg;
const aboutImgSrc = (aboutImg as any)?.src || aboutImg;
const servicesImgSrc = (servicesImg as any)?.src || servicesImg;
const venturesImgSrc = (venturesImg as any)?.src || venturesImg;
  ...
  return (
    <>
      ...
      >
        ...
        <HeroOverlays imageSrc={heroImgSrc} />
        ...
        <div className="container-tight">
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl p-8 sm:p-10 md:p-16">
              <img src={contactImgSrc} alt="" aria-hidden="true" loading="lazy" decoding="async" className="absolute inset-0 h-full w-full object-cover" />
